...
$mail->Password = 'oOAryajAR11%'; // Ваш пароль от почты с которой будут отправляться письма
...
$mail->Body    = '' .$name .$surname. ' оставил заявку<br>Почта этого пользователя: ' .$email;
$mail->AltBody = '';
